          ...
          <div className="grid grid-cols-12 gap-1">
            ...
            <div className="col-span-1 ">
              <button type="submit"
                ...
                <img alt="Edit Icon" src={saveImg} className="max-w-full max-h-full" />
              </button>
            </div>
          </div>
        </form>
        ...
        <div className="grid grid-cols-12 gap-1">
          ...
          <div  className="col-span-1">
            <button onClick={() => setIsEditTitle(!isEditTitle)}
              ...
              <img alt="Edit Icon" src={editImg}  className=" max-w-full max-h-full" />
            </button>
          </div>
          {/* <div className="col-span-1">
            <button
             ...
             className="flex h-full items-center justify-center">
              <img alt="Delete Icon" src={deleteImg} className="max-w-full max-h-full" />
            </button>
